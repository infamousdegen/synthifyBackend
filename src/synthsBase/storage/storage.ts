...
export let TokenState = new StableBTreeMap<nat,State>(0,44,5_000_000)
...
export let AccountBalance = new StableBTreeMap<Account,nat>(1,44,1024)

export let AllowanceStorage = new StableBTreeMap<AllowanceKey,AllowanceStorageData>(2,44,1024)
